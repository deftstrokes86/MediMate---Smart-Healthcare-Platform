...
const formSchema = z.object({
  ...
  usePseudonym: z.boolean().optional(),
            ...
            return ( // Adult patient form
                <div className="space-y-6">
                    ...
                    <div className="space-y-4 rounded-md border p-4">
                        <h4 className="text-md font-semibold font-headline">Privacy Settings</h4>
                        <FormField control={form.control} name="pseudonym" render={({ field }) => (<FormItem><FormLabel>Pseudonym (Optional)</FormLabel><FormControl><Input placeholder="e.g. BlueJay" {...field} /></FormControl><FormDescription>This name will be displayed during consultations if you enable it below.</FormDescription><FormMessage /></FormItem>)} />
                        <FormField
                            ...
                            render={({ field }) => (
                                ...
                                <div className="space-y-1 leading-none">
                                    <FormLabel>
                                        Use Pseudonym in Consultations
                                    </FormLabel>
                                </div>
                                </FormItem>
                            )}
